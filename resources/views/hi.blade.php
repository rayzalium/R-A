                    ...
                    <div class="col-12 col-md-8 col-lg-6 justify-content-center">
                        <div class="card bg-primary shadow-soft border-light p-4">
                            <div class="row">
                                ...
                                <div class="col text-end d-flex flex-row-reverse " style="width: 40;"> <img class="float-end " style="max-width: 40%;" src="1280px-Yemenia_Logo.svg.png" ></div>
                                ...
                                <form action="#" class="mt-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon3" placeholder="email" type="text" aria-label="email adress">
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-group">
